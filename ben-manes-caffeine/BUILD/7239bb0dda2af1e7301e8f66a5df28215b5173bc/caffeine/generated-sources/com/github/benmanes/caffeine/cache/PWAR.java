...
class PWAR<K, V> extends PWA<K, V> {
  protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PWAR.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.WRITE_TIME);
  ...
  PWAR(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
