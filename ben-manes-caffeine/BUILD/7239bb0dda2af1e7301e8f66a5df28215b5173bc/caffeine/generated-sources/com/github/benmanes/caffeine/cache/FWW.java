...
class FWW<K, V> extends FW<K, V> {
  protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FWW.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.WRITE_TIME);
  ...
  FWW(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
