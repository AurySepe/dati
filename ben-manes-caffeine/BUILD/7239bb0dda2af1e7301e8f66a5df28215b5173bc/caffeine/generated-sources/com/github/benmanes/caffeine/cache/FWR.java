...
class FWR<K, V> extends FW<K, V> {
  protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FWR.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.WRITE_TIME);
  ...
  FWR(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
