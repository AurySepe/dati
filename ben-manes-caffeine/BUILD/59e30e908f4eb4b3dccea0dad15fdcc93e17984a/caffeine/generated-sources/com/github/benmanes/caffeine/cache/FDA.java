...
class FDA<K, V> extends FD<K, V> {
  protected static final long ACCESS_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FDA.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.ACCESS_TIME);
  ...
  FDA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
