...
class PDW<K, V> extends PD<K, V> {
  protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PDW.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.WRITE_TIME);
  ...
  PDW(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
