...
class FSA<K, V> extends FS<K, V> {
  protected static final long ACCESS_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FSA.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.ACCESS_TIME);
  ...
  FSA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
