...
class PSA<K, V> extends PS<K, V> {
  protected static final long ACCESS_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PSA.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.ACCESS_TIME);
  ...
  PSA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue,
      int weight, long now) {
